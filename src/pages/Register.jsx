    ...
    <div className="min-h-screen bg-crmBg flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-crmCard rounded-3xl border border-gray-800 shadow-2xl p-8 relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-white text-center tracking-tight">Create Account</h2>
          <p className="text-gray-400 text-sm mt-2">Get started with AI-native marketing tools</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm">
          ...
          <button onClick={onToggleLogin} className="text-crmAccent hover:text-purple-400 font-semibold underline underline-offset-4">
            Sign In Instead
          </button>
        </div>
      </div>
